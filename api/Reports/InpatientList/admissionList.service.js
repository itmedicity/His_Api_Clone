...
module.exports = {
  ...
  getTsshPatientDateWise: (data, callBack) => {
    pool.query(`SELECT * FROM tssh_ipadmiss WHERE date = ?`, [data.date], (error, results, feilds) => {
      if (error) {
        return callBack(error);
      }
      return callBack(null, results);
  ...
  deleteIPNumberFromTssh: (data, callBack) => {
    pool.query(`DELETE FROM tssh_ipadmiss WHERE ip_slno IN (?)`, [data], (error, results, feilds) => {
      if (error) {
        return callBack(error);
      }
      return callBack(null, results);
  ...
  getLastDischargeUpdateDate: (callBack) => {
    pool.query(`SELECT Last_dis_updateDate FROM last_dis_updatedate`, [], (error, results, feilds) => {
      if (error) {
        return callBack(error);
      }
      return callBack(null, results);
  ...
  updateLastDischargeDate: (data, callBack) => {
    pool.query(`UPDATE last_dis_updatedate SET Last_dis_updateDate = ? WHERE slno = 1`, [data.date], (error, results, feilds) => {
      if (error) {
        return callBack(error);
      }
      return callBack(null, results);
