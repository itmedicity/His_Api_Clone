...
module.exports = {
  getpharmacySalePart1: controllerHelper(pharmacySalePart1, "Pharmacy Sale"),
  getpharmacyReturnPart1: controllerHelper(phamracyReturnPart1, "Pharmacy Return"),
  getphamracySalePart2: controllerHelper(phamracySalePart2, "Pharmacy Sale"),
  getphamracyReturnPart2: controllerHelper(phamracyReturnPart2, "Pharmacy Return"),
  getphamracySalePart3: controllerHelper(phamracySalePart3, "Pharmacy Sale"),
  getphamracyReturnPart3: controllerHelper(phamracyReturnPart3, "Pharmacy Return"),
