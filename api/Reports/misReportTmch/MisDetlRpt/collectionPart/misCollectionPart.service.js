  ...
  creditInsuranceBillDetlPart4: async (data) => {
    ...
    const sql = `SELECT INITCAP (Ptc_ptname) ptname,
                        ...
                        WHERE     Pbillmast.Pt_no = Patient.Pt_no(+)
                                ...
                                AND PBILLMAST.IP_NO NOT IN ${ipNumberList.clause}
                        GROUP BY Ptc_ptname,
                                Pbillmast.Pt_no,
                                Bm_no,
                                Cuc_name,
  ...
  advanceCollection: async (data) => {
    ...
    const sql = `SELECT INITCAP (Ptc_ptname) Ptname,
                        ...
                        WHERE     Opadvance.Pt_no = Patient.Pt_no
                                ...
                                AND OPADVANCE.IP_NO NOT IN ${ipNumberList.clause}
                        GROUP BY Ptc_ptname,
                                Opadvance.Pt_no,
                                Ar_no,
                                Usc_name
                        ...
                        WHERE     Ipadvance.Ip_no = Ipadmiss.Ip_no
                                ...
                                AND Ipadmiss.IP_NO NOT IN ${ipNumberList.clause}
                        GROUP BY Patient.Ptc_ptname,
                                Patient.Pt_no,
                                Ar_no,
                                Usc_name
  ...
  creditInsuranceBillCollection2: async (data) => {
    ...
    const sql = `SELECT X.Rc_no BillNo,
                    ...
                    WHERE     X.Cu_code = Y.Cu_code
                            ...
                            AND R.IP_NO NOT IN ${ipNumberList.clause}
                    UNION 
