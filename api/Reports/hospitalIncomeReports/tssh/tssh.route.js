...
const {
  getTsshReport,
  getTsshCeditInsuranceBillCollection,
  getTsshCreditInsuranceBillDetail,
  getTssh_UnsettledAmount,
  getTssh_AdvanceCollection,
  getTssh_ProcedureDetails,
} = require("./tssh.controller");
...
router.post("/getTssh_ProcedureDetails", checkToken, getTssh_ProcedureDetails);
